...
// NOTE: ANIMAL_OBJECT (ID=6, "animal") has graphics/sounds in assets/ but is NOT loaded/rendered from .map files.
enum map_object_type
{
	ROCK_OBJECT,              // ✅ Supported
	BRIDGE_OBJECT,            // ✅ Supported
	BUILDING_OBJECT,          // ✅ Supported (7 types: fort/radar/etc)
	CANNON_OBJECT,            // ✅ Supported (4 types: gatling/gun/...)
	VEHICLE_OBJECT,           // ✅ Supported (7 types: jeep/light/apc/...)
	ROBOT_OBJECT,             // ✅ Supported (6 types: grunt/sniper/pyro/...)
	ANIMAL_OBJECT,            // ⚠️ NOT LOADED from .map files — has assets but no handler in zclient.cpp::CreateObject()
	MAP_ITEM_OBJECT,          // ✅ Supported (flags/grenades/hut/map_items)
	MAX_MAP_OBJECT_TYPES      // = 8
};
